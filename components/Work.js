...
export default function Work() {
    return (
        <div className="block p-4 pr-12 bg-white border-2 border-gray-100 rounded ">
            ...
            <div className="block relative m-3 p-5 border-2 border-gray-100 rounded">
                <div className="text-lg">個人開発</div>
                    ...
                    <Link href="/Works/portfolio_new">
                        <a className="text-base md:flex md:p-1 hover:opacity-80 border-b-2 border-gray-100 ml-4">
